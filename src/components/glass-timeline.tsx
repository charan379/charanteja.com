...
function GlassTimelineNode({
  ...
  return (
    <div className="relative">
      {/* Glow for current */}
      {status === "current" && (
        <div className="absolute -inset-2 rounded-full bg-linear-to-r from-cyan-500/50 to-blue-500/50 blur-xs animate-pulse" />
      )}
      ...
      <div
        className={cn(
          ...
          status === "completed" &&
            "bg-linear-to-br from-cyan-500 to-blue-500 border-cyan-400/50",
          status === "current" &&
            "bg-white/20 backdrop-blur-xl border-cyan-400/50",
          status === "upcoming" &&
