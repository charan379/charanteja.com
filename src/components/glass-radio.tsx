    ...
    <div className="flex items-center gap-3">
      <RadioGroupPrimitive.Item
        ...
        className={cn(
          ...
          "focus:outline-none focus-visible:ring-2 focus-visible:ring-zinc-400 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent",
          "disabled:cursor-not-allowed disabled:opacity-50",
          "data-[state=checked]:border-zinc-100",
          className,
        )}
        {...props}
      >
        <RadioGroupPrimitive.Indicator className="flex w-full h-full items-center justify-center">
          <motion.div
            className="h-2.5 w-2.5 rounded-full bg-linear-to-r from-zinc-100 to-zinc-300"
            initial="initial"
            animate="checked"
